...
wget -O.kodi.zip "https://media-gdgz-fy-person01.gd5oss.ctyunxs.cn/PERSONCLOUD/dc75b479-08a5-4e0b-aa99-c1b0ea91c815.zip?response-content-disposition=attachment%3Bfilename%3D%22.kodi.zip%22%3Bfilename*%3DUTF-8%27%27.kodi.zip&x-amz-CLIENTNETWORK=UNKNOWN&x-amz-CLOUDTYPEIN=PERSON&x-amz-CLIENTTYPEIN=WEB&Signature=VXtp5zylFBHNLosHd4PT7L%2BZ7KY%3D&AWSAccessKeyId=g6jU1T3TkAbPKf5ouH5d&x-amz-userLevel=7&Expires=1747218693&x-amz-limitrate=51200&x-amz-FSIZE=184584211&x-amz-UID=354906919&x-amz-UFID=324931194017670457"
if [ $? -ne 0 ]; then
